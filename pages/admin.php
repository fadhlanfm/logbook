<?php 
   session_start();
	...
	//asign a query
	// $query = " SELECT * FROM hasil_penjualan ";
	// //execute the query
...
<html lang="en">
  <head>
    ...
    <link href="../assets/gentelella/vendors/gentelellabootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a class="site_title"><i class="fa fa-paw"></i> <span>Admin</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                	<li><a href="../pages/admin.php"><i class="fa fa-bar-chart-o"></i> Dashboard</a>
                  	</li>                  
                  	<li><a href="../pages/responden.php"><i class="fa fa-user"></i> Responden </a>
                  	</li>
                	<li><a href="../pages/soal.php"><i class="fa fa-clone"></i> Soal </a>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a href="../pages/admin_settings.php" data-toggle="tooltip" data-placement="top" title="Settings">
                <span class="fa fa-wrench" aria-hidden="true"> Settings </span>
              </a>
            </div>
            <!-- /menu footer buttons -->
          </div>
        ...
        <footer>
          <div class="pull-right">
            Developed by <a href="https://www.linkedin.com/in/fadhlan-fariz-makarim-263951ab">24010313140113</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
