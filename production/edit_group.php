...
$id=$_GET['id'];  
$sql = mysqli_query($con,"SELECT * FROM survey_group WHERE id_group='$id';");
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate method="post" action="edit_group_.php" class="form-horizontal form-label-left" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="grup" name="grup" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['group_name'] ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <textarea id="desc" name="desc" class="resizable_textarea form-control" placeholder="" value=""><?php echo $row['group_desc'] ?></textarea>
                      </div>
                    </div>
