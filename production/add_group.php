...
?>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Tambah Grup <!-- <small>different form elements</small> --></h2>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate method="post" action="add_group_.php" class="form-horizontal form-label-left" >

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" >Nama Survey <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="name" name="name" class="form-control col-md-7 col-xs-12"  readonly="readonly" value="<?php echo "$id" ?>">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button name="submit" type="submit" class="btn btn-success" value="simpan" action onclick="func1()">Simpan</button>
                      </div>
                    </div>
  ...
  <script>
    ...
    <script type="text/javascript">
      function func1()
      {            
        document.getElementById("desc").value.replace(/\r\n|\r|\n/g,"<br />");
     }
   </script>
 </body>
 </html>
