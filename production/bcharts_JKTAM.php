...
<head>
  ...
  <title>Dashboard Branch Perspective: JKTAM</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM unit WHERE kode='JKTAM'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM unit WHERE kode='JKTAM'";
