<?php
  ...
  $query = "SELECT b.id_aktivitas, b.nama_aktivitas, b.desk_akt, a.id_subaktivitas, a.nama_subaktivitas, a.poin, a.max_freq, a.default2 FROM subaktivitas a JOIN aktivitas b ON b.id_aktivitas=a.id_aktivitas order by id_aktivitas LIMIT $start_from, $num_rec_per_page";
  //execute the query
