  ...
  <form method="POST" class="form-horizontal form-label-left" action="fgd_input_form_.php">
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" name="asesor" id="asesor" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo''.$row3->unit.''; ?>" readonly>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" name="asesor" id="asesor" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo''.$row3->asesor.''; ?>" readonly>
      </div>
    </div>
    <div class="form-group">
   ...
   <div class="form-group">
     <table class="table table-bordered">
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value1" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v1 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat1" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c1 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value2" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v2 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat2" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c2 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value3" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v3 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat3" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c3 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="3">
           <input type="text" name="value4" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v4 ?>" readonly>
         </td>
         <td rowspan="3">
           <textarea class="form-control" name="catat4" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c4 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value5" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v5 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat5" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c5 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="3">
           <input type="text" name="value6" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v6 ?>" readonly>
         </td>
         <td rowspan="3">
           <textarea class="form-control" name="catat6" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c6 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value7" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v7 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat7" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c7 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="3">
           <input type="text" name="value8" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v8 ?>" readonly>
         </td>
         <td rowspan="3">
           <textarea class="form-control" name="catat8" placeholder="Deskripsi" required="required" readonly><?php echo $row3->c8 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="4">
           <input type="text" name="value9" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v9 ?>" readonly>
         </td>
         <td rowspan="4">
           <textarea class="form-control" name="catat9" placeholder="Deskripsi" readonly> <?php echo $row3->c9 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
       ...
       <tr>
         ...
         <td rowspan="3">
           <input type="text" name="value10" class="form-control" placeholder="Nilai" required="required" value="<?php echo $row3->v10 ?>" readonly>
         </td>
         <td rowspan="3">
           <textarea class="form-control" name="catat10" readonly><?php echo $row3->c10 ?></textarea>
         </td>
       </tr>
       <tr>
         <td>
