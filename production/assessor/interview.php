  ...
  <div class="">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>List Penilaian Interview</h2>  
            <ul class="nav navbar-right panel_toolbox">
              <a href="inter_input.php"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Input penilaian interview baru</button></a>
            </ul>
            <div class="clearfix"></div>
          </div>
          ...
          <div class="x_content">
            ...
            <table class="table table-hover table-bordered table table-striped table-bordered dt-responsive nowrap" style="font-size:14px" id="datatable-responsive"  cellspacing="0" width="100%">
              ...
              <tbody>
                <?php 
                $n=1;
                $queries=mysqli_query($db,"SELECT *, ((v11+v12+v13+v14+v15+v16)/6+(v21+v22+v23+v24+v25+v26)/6+(v51+v52+v53+v54+v55+v56)/6+(v31+v32+v33+v34+v35+v36)/6+(v41+v42+v43+v44+v45+v46)/6)/5 x FROM inter");
                while ($row=mysqli_fetch_array($queries)) {
                  ?>
                  <tr>
                    <td style="text-align:center; vertical-align:middle"><?php echo $n++; ?></td>
                    <td style="vertical-align:middle"><a href="detail_inter.php?id=<?php echo $row['unit'];?>&as=<?php echo $row['asesor'];?>"><b><?php echo $row['unit'];?></b></a> </td>
