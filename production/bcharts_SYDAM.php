...
<?php
  ...
  $query = "SELECT kode_unit FROM logbook WHERE end >= curdate() AND kode_unit='SYDAM'"; //yg udah submit dan belom kelar
  $query1 = "SELECT kode FROM branch WHERE kode_unit='SYDAM' GROUP BY kode";
  $query3 = "SELECT id FROM logbook WHERE start <= curdate() and end >= curdate() and kode_unit='SYDAM'";

  $query4 = "SELECT id FROM logbook WHERE kode_unit='SYDAM' AND end < curdate()";
  ...
  $total_SYDAM=mysqli_num_rows($result4);
...
<head>
  ...
  <title>Dashboard Branch Perspective: SYDAM</title>
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-6 col-xs-14">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Program Terlaksana - SYDAM</h2>
                  ...
                  <div class="row tile_count">
                    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                      <span class="count_top"><i class="fa fa-check-square-o"></i> SYDAM - Jakarta Raya Region</span>
                      <div class="count"><?php echo $total_SYDAM; ?></div>
                    </div>
                    </div>
                  </div>
                  </div>
            ...
            <!-- CHART unit submit-->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="count"><?php echo ''.$tersubmit.'/'.$total.' Unit di SYDAM';?></div>
                </div>
                </div>
              </div>
            <!-- CHART unit submit-->
            ...
            <!-- CHART unit sedang berjalan -->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="tile-stats">
                  <div class="count"><?php echo ''.$running.'/'.$tersubmit.' Unit di SYDAM';?></div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM unit WHERE kode='SYDAM'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM unit WHERE kode='SYDAM'";
    ...
    <script>
      ...
      <?php
        ...
        $submitted_SYDDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SYDDM' AND start > curdate()";
        $running_SYDDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SYDDM' AND start <= curdate() and end >= curdate()";
        $ended_SYDDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SYDDM' AND end < curdate()";
        $submitted_PERDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='PERDM' AND start > curdate()";
        $running_PERDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='PERDM' AND start <= curdate() and end >= curdate()";
        $ended_PERDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='PERDM' AND end < curdate()";
        $submitted_MELDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='MELDM' AND start > curdate()";
        $running_MELDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='MELDM' AND start <= curdate() and end >= curdate()";
        $ended_MELDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='MELDM' AND end < curdate()";

        $submitted_SYDDM_result=$db->query($submitted_SYDDM_query);
        $running_SYDDM_result=$db->query($running_SYDDM_query);
        $ended_SYDDM_result=$db->query($ended_SYDDM_query);
        $submitted_PERDM_result=$db->query($submitted_PERDM_query);
        $running_PERDM_result=$db->query($running_PERDM_query);
        $ended_PERDM_result=$db->query($ended_PERDM_query);        
        $submitted_MELDM_result=$db->query($submitted_MELDM_query);
        $running_MELDM_result=$db->query($running_MELDM_query);
        $ended_MELDM_result=$db->query($ended_MELDM_query);

        $submitted_SYDDM=mysqli_num_rows($submitted_SYDDM_result);
        $running_SYDDM=mysqli_num_rows($running_SYDDM_result);
        $ended_SYDDM=mysqli_num_rows($ended_SYDDM_result);
        $submitted_PERDM=mysqli_num_rows($submitted_PERDM_result);
        $running_PERDM=mysqli_num_rows($running_PERDM_result);
        $ended_PERDM=mysqli_num_rows($ended_PERDM_result);       
        $submitted_MELDM=mysqli_num_rows($submitted_MELDM_result);
        $running_MELDM=mysqli_num_rows($running_MELDM_result);
        $ended_MELDM=mysqli_num_rows($ended_MELDM_result);
      ?>
      ...
      echartBar.setOption({
        ...
        series: [{
          name: 'Submitted',
          type: 'bar',
          data: [<?php echo $submitted_SYDDM.','.$submitted_PERDM.','.$submitted_MELDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Running',
          type: 'bar',
          data: [<?php echo $running_SYDDM.','.$running_PERDM.','.$running_MELDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Ended',
          type: 'bar',
          data: [<?php echo $ended_SYDDM.','.$ended_PERDM.','.$ended_MELDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
