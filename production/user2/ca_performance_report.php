										...
										<div class="ln_solid"></div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input type="text" name="hambatan[]" id="hambatan"  class="form-control col-md-7 col-xs-12" value="">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="solusi" name="solusi[]" class="resizable_textarea form-control" placeholder=""></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-3 col-sm-3 col-xs-12">
													<input type="text" class="form-control has-feedback-left xdisplay_inputx" id="single_cal2" name="start[]" placeholder="Tanggal" aria-describedby="inputSuccess2Status2" value="">
												...
												<div class="col-md-3 col-sm-3 col-xs-12">
													<input type="text" class="form-control has-feedback-left xdisplay_inputx" id="single_cal3" name="end[]" placeholder="Tanggal" aria-describedby="inputSuccess2Status2" value="">
													<span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="desc" name="followup[]" class="resizable_textarea form-control" placeholder=""></textarea>
												</div>
											</div>
