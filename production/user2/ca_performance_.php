...
if($_POST['submit']=='simpan')      { 
	...
	$cekisi=mysqli_query($con,"SELECT * FROM ca_performance_upload where username='$name'");
	...
	if($rowc['file2']==null || empty($rowc['file2'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql2= mysqli_query($con,"UPDATE ca_performance_upload SET file2='$final_file2', status_f2='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update2=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 2', '$final_file2', '$name', 'unread', '$date')");
	...
	if($rowc['file3']==null || empty($rowc['file3'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql3= mysqli_query($con,"UPDATE ca_performance_upload SET file3='$final_file3', status_f3='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update3=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 3', '$final_file3', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file4']==null || empty($rowc['file4'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql4= mysqli_query($con,"UPDATE ca_performance_upload SET file4='$final_file4', status_f4='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update4=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 4', '$final_file4', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file5']==null || empty($rowc['file5'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql5= mysqli_query($con,"UPDATE ca_performance_upload SET file5='$final_file5', status_f5='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update5=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 5', '$final_file5', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file6']==null || empty($rowc['file6'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql6 = mysqli_query($con,"UPDATE ca_performance_upload SET file6='$final_file6', status_f6='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update6=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 6', '$final_file6', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file7']==null || empty($rowc['file7'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql7= mysqli_query($con,"UPDATE ca_performance_upload SET file7='$final_file7', status_f7='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update7=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 7', '$final_file7', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file8']==null || empty($rowc['file8'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql8 = mysqli_query($con,"UPDATE ca_performance_upload SET file8='$final_file8', status_f8='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update8=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 8', '$final_file8', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file9']==null || empty($rowc['file9'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql9 = mysqli_query($con,"UPDATE ca_performance_upload SET file9='$final_file9', status_f9='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update9 =mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 9', '$final_file9', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
	...
	if($rowc['file10']==null || empty($rowc['file10'])){
		...
		// make file name in lower case
			...
			// if everything is ok, try to upload file
				...
				$sql10 = mysqli_query($con,"UPDATE ca_performance_upload SET file10='$final_file10', status_f10='uploaded', last_modified='$date' where username='$name' and ca_name='$unit'");
				$update10=mysqli_query($con,"INSERT INTO ca_performance_activity (activity_detail, activity_file, username, status, last_modified) values ('$name menambahkan file baru kedalam Change Agent Event 10', '$final_file10', '$name', 'unread', '$date')");
				if (mysqli_affected_rows($con)>0){
					header('Location: ca_performance.php');
					echo "berhasil diedit";
				}
