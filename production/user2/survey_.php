      ...
      <div class="right_col" role="main">
        <div class="">
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate method="post" action="survey_submit.php" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="unit-name" name="unit" readonly  class="form-control col-md-7 col-xs-12" value="<?php echo "$row2[unit]"; ?>">
                      </div>
                    </div>
                  </form>
          ...
          <form id="demo-form2" data-parsley-validate method="post" action="survey_submit.php" class="form-horizontal form-label-left">
            ...
            <input type="text" name="username" value="<?php echo "$coba"; ?>" style="display:none">
            <input type="text" name="unit" value="<?php echo "$row2[unit]"; ?>" style="display:none">
