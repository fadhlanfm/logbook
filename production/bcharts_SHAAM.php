...
<?php
  ...
  $query = "SELECT kode_unit FROM logbook WHERE end >= curdate() AND kode_unit='SHAAM'"; //yg udah submit dan belom kelar
  $query1 = "SELECT kode FROM branch WHERE kode_unit='SHAAM' GROUP BY kode";
  $query3 = "SELECT id FROM logbook WHERE start <= curdate() and end >= curdate() and kode_unit='SHAAM'";

  $query4 = "SELECT id FROM logbook WHERE kode_unit='SHAAM' AND end < curdate()";
  ...
  $total_SHAAM=mysqli_num_rows($result4);
...
<head>
  ...
  <title>Dashboard Branch Perspective: SHAAM</title>
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-6 col-xs-14">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Program Terlaksana - SHAAM</h2>
                  ...
                  <div class="row tile_count">
                    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                      <span class="count_top"><i class="fa fa-check-square-o"></i> SHAAM - Jakarta Raya Region</span>
                      <div class="count"><?php echo $total_SHAAM; ?></div>
                    </div>
                    </div>
                  </div>
                  </div>
            ...
            <!-- CHART unit submit-->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="count"><?php echo ''.$tersubmit.'/'.$total.' Unit di SHAAM';?></div>
                </div>
                </div>
              </div>
            <!-- CHART unit submit-->
            ...
            <!-- CHART unit sedang berjalan -->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="tile-stats">
                  <div class="count"><?php echo ''.$running.'/'.$tersubmit.' Unit di SHAAM';?></div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM unit WHERE kode='SHAAM'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM unit WHERE kode='SHAAM'";
    ...
    <script>
      ...
      <?php
        ...
        $submitted_SHADM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SHADM' AND start > curdate()";
        $running_SHADM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SHADM' AND start <= curdate() and end >= curdate()";
        $ended_SHADM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='SHADM' AND end < curdate()";
        $submitted_BJSDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='BJSDM' AND start > curdate()";
        $running_BJSDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='BJSDM' AND start <= curdate() and end >= curdate()";
        $ended_BJSDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='BJSDM' AND end < curdate()";
        $submitted_CANDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='CANDM' AND start > curdate()";
        $running_CANDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='CANDM' AND start <= curdate() and end >= curdate()";
        $ended_CANDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='CANDM' AND end < curdate()";
        $submitted_HKGDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='HKGDM' AND start > curdate()";
        $running_HKGDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='HKGDM' AND start <= curdate() and end >= curdate()";
        $ended_HKGDM_query= "SELECT kode_branch FROM logbook WHERE kode_branch='HKGDM' AND end < curdate()";

        $submitted_SHADM_result=$db->query($submitted_SHADM_query);
        $running_SHADM_result=$db->query($running_SHADM_query);
        $ended_SHADM_result=$db->query($ended_SHADM_query);
        $submitted_BJSDM_result=$db->query($submitted_BJSDM_query);
        $running_BJSDM_result=$db->query($running_BJSDM_query);
        $ended_BJSDM_result=$db->query($ended_BJSDM_query);        
        $submitted_CANDM_result=$db->query($submitted_CANDM_query);
        $running_CANDM_result=$db->query($running_CANDM_query);
        $ended_CANDM_result=$db->query($ended_CANDM_query);
        $submitted_HKGDM_result=$db->query($submitted_HKGDM_query);
        $running_HKGDM_result=$db->query($running_HKGDM_query);
        $ended_HKGDM_result=$db->query($ended_HKGDM_query);

        $submitted_SHADM=mysqli_num_rows($submitted_SHADM_result);
        $running_SHADM=mysqli_num_rows($running_SHADM_result);
        $ended_SHADM=mysqli_num_rows($ended_SHADM_result);
        $submitted_BJSDM=mysqli_num_rows($submitted_BJSDM_result);
        $running_BJSDM=mysqli_num_rows($running_BJSDM_result);
        $ended_BJSDM=mysqli_num_rows($ended_BJSDM_result);       
        $submitted_CANDM=mysqli_num_rows($submitted_CANDM_result);
        $running_CANDM=mysqli_num_rows($running_CANDM_result);
        $ended_CANDM=mysqli_num_rows($ended_CANDM_result);
        $submitted_HKGDM=mysqli_num_rows($submitted_HKGDM_result);
        $running_HKGDM=mysqli_num_rows($running_HKGDM_result);
        $ended_HKGDM=mysqli_num_rows($ended_HKGDM_result);
      ?>
      ...
      echartBar.setOption({
        ...
        series: [{
          name: 'Submitted',
          type: 'bar',
          data: [<?php echo $submitted_SHADM.','.$submitted_BJSDM.','.$submitted_CANDM.','.$submitted_HKGDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Running',
          type: 'bar',
          data: [<?php echo $running_SHADM.','.$running_BJSDM.','.$running_CANDM.','.$running_HKGDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Ended',
          type: 'bar',
          data: [<?php echo $ended_SHADM.','.$ended_BJSDM.','.$ended_CANDM.','.$ended_HKGDM; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
