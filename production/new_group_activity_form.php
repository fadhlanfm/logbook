...
<head>
  ...
  <title>Tambah Kelompok Baru</title>
...
<div class="right_col" role="main">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel tile">
      ...
      <div class="x_content">
        <!-- insert content here -->
        <form method="POST" action="post_new_group.php">
          <div class="form-group">
            <label for="iduser">Nama Kelompok</label>
            <input class="form-control" type="text" id="nama_aktivitas" name="nama_aktivitas" required="required"></input><br>
            <label for="iduser">Deskripsi Kelompok</label>
            <textarea class="form-control" id="desk_akt" name="desk_akt" required="required"></textarea><br>
