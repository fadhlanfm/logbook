...
<div class="right_col" role="main">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel tile">
      ...
      <div class="x_content">
        <!-- insert content here -->
        <form method="POST" action="post_new_activity.php">
          <label for="nama_sub">Nama Aktivitas : </label>
          <input  class="form-control"type="text" id="nama_sub" name="nama_sub" required="required"></input>
          <br>
          <label for="id_akt">Grup Aktivitas : </label>
          <select name="id_akt" class="form-control" required="required">
            <option disabled="disabled" selected="selected">Silahkan pilih...</option>
            <?php
            $qq = "select * from aktivitas";
            $rst = $db->query($qq);
            while ($roo = $rst->fetch_object()) {
              ?>
            <option value="<?php echo $roo->id_aktivitas ?>"
            ><?php echo $roo->nama_aktivitas ?></option>
            <?php 
            }
          ...
          <input class="form-control" type="text" id="poin" placeholder="Poin" name="poin"></input><br>
          <label for="freq">Frekuensi Maksimal : </label>
          <input class="form-control" type="text" id="freq" placeholder="Frekuensi Maksimal" name="freq"></input><br>
