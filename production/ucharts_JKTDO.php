...
<?php
  ...
  $query4 = "SELECT id FROM logbook WHERE kode_dir='JKTDO' AND end < curdate()";
  ...
  $total_JKTDO=mysqli_num_rows($result4);
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM direktorat WHERE kode='JKTDO'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM direktorat WHERE kode='JKTDO'";
    ...
    <script>
      ...
      echartBar.setOption({
        ...
        series: [{
          name: 'Submitted',
          type: 'bar',
          data: [<?php echo $submitted_JKTOS.','.$submitted_JKTOG.','.$submitted_JKTOF; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Running',
          type: 'bar',
          data: [<?php echo $running_JKTOS.','.$running_JKTOG.','.$running_JKTOF; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Ended',
          type: 'bar',
          data: [<?php echo $ended_JKTOS.','.$ended_JKTOG.','.$ended_JKTOF; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
