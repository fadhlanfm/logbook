          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><a><button class="btn btn-success btn-xs" id="clickme" onclick="clickity()">Beri Evaluasi</button></a>
                </li>
...
<form action="post_komentar_logbook.php" method="POST"><br>
  ...
  <div class="input-field col s12">
    <textarea id="deskripsi" class="form-control" name="komentar" required ><?php echo $row->komentar;?></textarea>
    <label for="deskripsi">Evaluasi Logbook</label>
  </div>
