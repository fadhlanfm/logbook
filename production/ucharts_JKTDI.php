                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM direktorat WHERE kode='JKTDI'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM direktorat WHERE kode='JKTDI'";
