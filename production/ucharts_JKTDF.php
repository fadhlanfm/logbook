...
<?php
  ...
  $query = "SELECT kode_unit FROM logbook WHERE end >= curdate() AND kode_dir='JKTDF' GROUP BY kode_unit"; //yg udah submit dan belom kelar
  $query1 = "SELECT kode FROM unit WHERE kode_dir='JKTDF' GROUP BY kode";
  $query3 = "SELECT id FROM logbook WHERE start <= curdate() and end >= curdate() and kode_dir='JKTDF'";

  $query4 = "SELECT id FROM logbook WHERE kode_dir='JKTDF' AND end < curdate()";
  ...
  $total_JKTDF=mysqli_num_rows($result4);
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-6 col-xs-14">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Program Terlaksana - JKTDF</h2>
                  ...
                  <div class="row tile_count">
                    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                      ...
                      <div class="count"><?php echo $total_JKTDF; ?></div>
                    </div>
                    </div>
                  </div>
                  </div>
            ...
            <!-- CHART unit submit-->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="count"><?php echo ''.$tersubmit.'/'.$total.' Unit di JKTDF';?></div>
                </div>
                </div>
              </div>
            <!-- CHART unit submit-->
            ...
            <!-- CHART unit sedang berjalan -->
              <div class="col-md-6 col-sm-6 col-xs-14">
                <div class="x_panel">
                  ...
                  <div class="tile-stats">
                  <div class="count"><?php echo ''.$running.'/'.$tersubmit.' Unit di JKTDF';?></div>
...
<!-- TABEL -->
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php
                        $quero = "SELECT * FROM direktorat WHERE kode='JKTDF'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php 
                        $today=date("Y-m-d");
                        $queri = "SELECT * FROM direktorat WHERE kode='JKTDF'";
    ...
    <script>
      ...
      <?php
        ...
        $submitted_JKTWF_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWF' AND start > curdate()";
        $running_JKTWF_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWF' AND start <= curdate() and end >= curdate()";
        $ended_JKTWF_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWF' AND end < curdate()";
        $submitted_JKTWA_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWA' AND start > curdate()";
        $running_JKTWA_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWA' AND start <= curdate() and end >= curdate()";
        $ended_JKTWA_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWA' AND end < curdate()";
        $submitted_JKTWL_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWL' AND start > curdate()";
        $running_JKTWL_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWL' AND start <= curdate() and end >= curdate()";
        $ended_JKTWL_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWL' AND end < curdate()";
        $submitted_JKTWR_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWR' AND start > curdate()";
        $running_JKTWR_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWR' AND start <= curdate() and end >= curdate()";
        $ended_JKTWR_query= "SELECT kode_unit FROM logbook WHERE kode_unit='JKTWR' AND end < curdate()";

        $submitted_JKTWF_result=$db->query($submitted_JKTWF_query);
        $running_JKTWF_result=$db->query($running_JKTWF_query);
        $ended_JKTWF_result=$db->query($ended_JKTWF_query);
        $submitted_JKTWA_result=$db->query($submitted_JKTWA_query);
        $running_JKTWA_result=$db->query($running_JKTWA_query);
        $ended_JKTWA_result=$db->query($ended_JKTWA_query);        
        $submitted_JKTWL_result=$db->query($submitted_JKTWL_query);
        $running_JKTWL_result=$db->query($running_JKTWL_query);
        $ended_JKTWL_result=$db->query($ended_JKTWL_query);
        $submitted_JKTWR_result=$db->query($submitted_JKTWR_query);
        $running_JKTWR_result=$db->query($running_JKTWR_query);
        $ended_JKTWR_result=$db->query($ended_JKTWR_query);

        $submitted_JKTWF=mysqli_num_rows($submitted_JKTWF_result);
        $running_JKTWF=mysqli_num_rows($running_JKTWF_result);
        $ended_JKTWF=mysqli_num_rows($ended_JKTWF_result);
        $submitted_JKTWA=mysqli_num_rows($submitted_JKTWA_result);
        $running_JKTWA=mysqli_num_rows($running_JKTWA_result);
        $ended_JKTWA=mysqli_num_rows($ended_JKTWA_result);       
        $submitted_JKTWL=mysqli_num_rows($submitted_JKTWL_result);
        $running_JKTWL=mysqli_num_rows($running_JKTWL_result);
        $ended_JKTWL=mysqli_num_rows($ended_JKTWL_result);
        $submitted_JKTWR=mysqli_num_rows($submitted_JKTWR_result);
        $running_JKTWR=mysqli_num_rows($running_JKTWR_result);
        $ended_JKTWR=mysqli_num_rows($ended_JKTWR_result);
      ?>
      ...
      echartBar.setOption({
        ...
        series: [{
          name: 'Submitted',
          type: 'bar',
          data: [<?php echo $submitted_JKTWF.','.$submitted_JKTWA.','.$submitted_JKTWL.','.$submitted_JKTWR; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Running',
          type: 'bar',
          data: [<?php echo $running_JKTWF.','.$running_JKTWA.','.$running_JKTWL.','.$running_JKTWR; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
          ...
          name: 'Ended',
          type: 'bar',
          data: [<?php echo $ended_JKTWF.','.$ended_JKTWA.','.$ended_JKTWL.','.$ended_JKTWR; ?>],
          markPoint: {
            data: [{
              type: 'max',
              name: 'max'
