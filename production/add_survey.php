            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate method="post" action="add_survey_.php" class="form-horizontal form-label-left" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12"> -->
                              <!-- <div class="col-md-7 col-xs-12 xdisplay_inputx form-group has-feedback"> -->
                                <input type="text" class="form-control has-feedback-left xdisplay_inputx " required="required" id="single_cal2" name="start" placeholder="Tanggal" aria-describedby="inputSuccess2Status2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!-- <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12"> -->
                              <!-- <div class="col-md-7 col-xs-12 xdisplay_inputx form-group has-feedback"> -->
                                <input type="text" class="form-control has-feedback-left xdisplay_inputx " required="required" id="single_cal3" name="end" placeholder="Tanggal" aria-describedby="inputSuccess2Status2">
                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                              <!-- </div> -->
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="url" name="url" required="required" placeholder="http://" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
