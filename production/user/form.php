    ...
    <div class="container body">
      <div class="main_container">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <tbody>
                                <div id="placeholder">
                                  ...
                                  <a href="#" class="add" rel=".clone">
                                    <button id="buttonadd" type="button" class="right btn waves-effect waves-light">Add new item</button></a>
                                  </div>
                                </tr>
                                <tr>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select class="form-control" name="monitoring" required="required">
                                <option value="" disabled selected>Choose your option</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select class="form-control" name="positif" required="required">
                                <option value="" disabled selected>Choose your option</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select class="form-control" name="negatif" required="required">
                                <option value="" disabled selected>Choose your option</option>
                          ...
                          <div class="form-group">
                            <table  class="table table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td>Ketua</td>
                                  <td><input id="nama_ketua" type="text" class="validate form-control" name="nama_ketua" required="required"></td>
                                  <td><input id="email_ketua" type="text" class="validate form-control" name="email_ketua" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Sekretaris & Bendahara</td>
                                  <td><input id="nama_sekre" type="text" class="validate form-control" name="nama_sekre" required="required"></td>
                                  <td><input id="email_sekre" type="text" class="validate form-control" name="email_sekre" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Dokumentasi & Publikasi</td>
                                  <td><input id="nama_pdd" type="text" class="validate form-control" name="nama_pdd" required="required"></td>
                                  <td><input id="email_pdd" type="text" class="validate form-control" name="email_pdd" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Corporate Program</td>
                                  <td><input id="nama_corp" type="text" class="validate form-control" name="nama_corp" required="required"></td>
                                  <td><input id="email_corp" type="text" class="validate form-control" name="email_corp" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Pic Rating</td>
                                  <td><input id="nama_rating" type="text" class="validate form-control" name="nama_rating" required="required"></td>
                                  <td><input id="email_rating" type="text" class="validate form-control" name="email_rating" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Pic I-Dare</td>
                                  <td><input id="nama_dare" type="text" class="validate form-control" name="nama_dare" required="required"></td>
                                  <td><input id="email_dare" type="text" class="validate form-control" name="email_dare" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Program Pendukung</td>
                                  <td><input id="nama_pendukung" type="text" class="validate form-control" name="nama_pendukung" required="required"></td>
                                  <td><input id="email_pendukung" type="text" class="validate form-control" name="email_pendukung" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Pic Sharing Session</td>
                                  <td><input id="nama_share" type="text" class="validate form-control" name="nama_share" required="required"></td>
                                  <td><input id="email_share" type="text" class="validate form-control" name="email_share" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Pic One Team One Spirit One Goal Program</td>
                                  <td><input id="nama_spirit" type="text" class="validate form-control" name="nama_spirit" required="required"></td>
                                  <td><input id="email_spirit" type="text" class="validate form-control" name="email_spirit" required="required"></td>
                                </tr>

                                <tr>
                                  <td>Pic Standar Layanan</td>
                                  <td><input id="nama_standar" type="text" class="validate form-control" name="nama_standar" required="required"></td>
                                  <td><input id="email_standar" type="text" class="validate form-control" name="email_standar" required="required"></td>
                                </tr>
                                <tr>
                                  <td>Attachment</td>
                                  <td colspan="2"><input class="btn btn-primary" type="file" name="file" /></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
        ...
        <script type="text/javascript">
          $(function(){
            var removeLink = ' <a class="remove" href="#" onclick="$(this).parent().slideUp(function(){ $(this).remove() }); return false"><button class="btn">remove</button></a>';
