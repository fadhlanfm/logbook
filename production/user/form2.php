      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
            <form data-parsley-validate class="form-horizontal form-label-left" action="review_form.php" method="POST" enctype="multipart/form-data">
              <form data-parsley-validate class="form-horizontal form-label-left" action="post_form.php" method="POST" enctype="multipart/form-data">
                <form data-parsley-validate class="form-horizontal form-label-left" action="post_form.php" method="POST">
                  <div class="row">
                    ...
                    //execute the query
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="nama_program" name="nama-program" required="required" class="form-control col-md-7 col-xs-12 validate">
                            </div>
                          </div>
                          <div class="form-group">
                                  ...
                                  <tr>
                                    ...
                                    <br />
                                      ...
                                      <div class="col-sm-3 col-md-3 col-xs-12">
                                        ...
                                        <select class="form-control" name="aktifitas[]" required>
