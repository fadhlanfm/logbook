					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 ">
							<div class="x_panel ui-ribbon-container ">
								...
								<div class="x_content">
									<?php 
									$barrier=mysqli_query($con,"SELECT * FROM unit_performance_report where username='$coba' and id_report='$rowx'");
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="unit_performance_report_.php" method="POST"  enctype="multipart/form-data">
										...
										<div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2">
											<a href="unit_performance.php"><button id="buttonadd" type="button" class="right btn waves-effect waves-light " >Kembali</button></a>
										</div>
									</form>
								</div>
							</div>
